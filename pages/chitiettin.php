...
<h1 class="title"><?php echo $row_tin['TieuDe'];
?></h1>
<div class="des" style="font-weight: bolder;">
...
<div class="number_count"><span id="like-total-1000000-3023795"><?php echo $row_tin['SoLanXem']
?></span></div>
<!--face-->
...
while ($row_tincungloai = mysql_fetch_array($tincungloai)) {
	...
	?>
        ...
        <li>
             <a href="index.php?p=chitiettin&idLT=<?php echo $row_tincungloai['idLT']
	?>&idTin=<?php echo $row_tincungloai['idTin']
	?>"><img src="upload/tintuc/<?php echo $row_tincungloai['urlHinh']
	?>" ></a> <br />
 			 <a class="title" href="index.php?p=chitiettin&idLT=<?php echo $row_tincungloai['idLT']
	?>&idTin=<?php echo $row_tincungloai['idTin']
	?>"><?php echo $row_tincungloai['TieuDe']
	?></a>
             <span class="no_wrap">
        </li>
        <?php
